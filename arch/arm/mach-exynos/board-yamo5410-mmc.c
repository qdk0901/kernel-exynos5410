...
static struct dw_mci_board smdk5410_dwmci1_pdata __initdata = {
	...
	.caps			= MMC_CAP_UHS_SDR50 | MMC_CAP_UHS_DDR50 |
				  ...
				  MMC_CAP_SDIO_IRQ,
#else
	.caps			= MMC_CAP_4_BIT_DATA | MMC_CAP_SDIO_IRQ | MMC_CAP_UHS_SDR104 | MMC_CAP_MMC_HIGHSPEED/* | MMC_CAP_SD_HIGHSPEED*/,
...
#else
	.sdr_timing 			= 0x81020000,//0x81040000,
...
void __init exynos5_yamo5410_mmc_init(void)
{
#ifdef CONFIG_MMC_DW
	if (samsung_rev() < EXYNOS5410_REV_1_0)

...
#define YAMO5410_PMIC_EINT	IRQ_EINT(0)
...
static struct regulator_consumer_supply __initdata s2m_bt_en32khz_consumer[] = {
	REGULATOR_SUPPLY("wlan_32khz", NULL),
	REGULATOR_SUPPLY("bt_32khz", NULL),
	REGULATOR_SUPPLY("gps_32khz", NULL),
	REGULATOR_SUPPLY("fm_32khz", NULL),
};
...
static struct regulator_init_data __initdata s2m_bt_en32khz_data = {
        .constraints    = {
                .name           = "32khz_bt_wlan",
        //      .always_on      = 1,
                .valid_ops_mask = REGULATOR_CHANGE_STATUS,
        ...
        .consumer_supplies      = &s2m_bt_en32khz_consumer,
};
...
{
	unsigned int pin = irq_to_gpio(YAMO5410_PMIC_EINT);
...
#if defined(CONFIG_BATTERY_PM2301) || defined(CONFIG_CHARGER_SMB349)
...
static struct platform_device *yamo5410_power_devices[] __initdata = {
...
void __init exynos5_yamo5410_power_init(void)
{
	exynos5_hs_i2c1_set_platdata(&hs_i2c0_data);
	...
	s3c_set_platdata(&exynos5_tmu_data, sizeof(struct exynos_tmu_platform_data),
			&exynos5410_device_tmu);
	platform_add_devices(yamo5410_power_devices,
			ARRAY_SIZE(yamo5410_power_devices));
}

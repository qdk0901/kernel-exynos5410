...
static struct s5p_mfc_qos yamo5410_mfc_qos_table[] = {
	[0] = {
		.thrd_mb	= 0,
		.freq_int	= 160000,
#ifdef CONFIG_S5P_DP
...
static struct s5p_mfc_platdata yamo5410_mfc_pd = {
	.ip_ver		= IP_VER_MFC_5A_1,
	.clock_rate	= 333 * MHZ,
#ifdef CONFIG_ARM_EXYNOS5410_BUS_DEVFREQ
	.num_qos_steps	= ARRAY_SIZE(yamo5410_mfc_qos_table),
	.qos_table	= yamo5410_mfc_qos_table,
#endif
};
#endif
...
static struct platform_device *yamo5410_media_devices[] __initdata = {
...
#ifdef CONFIG_VIDEO_EXYNOS5_FIMC_IS
static struct exynos5_sensor_gpio_info gpio_yamo5410 = {
	.cfg = {
		/* Rear Camera setting-----------------------*/
		/* 8M MCLK */
		{
...
void __init exynos5_yamo5410_media_init(void)
{
#if defined (CONFIG_CSI_D) || defined (CONFIG_S5K6B2_CSI_D)
...
#endif
#ifdef CONFIG_VIDEO_EXYNOS_MFC
	s5p_mfc_set_platdata(&yamo5410_mfc_pd);
	...
	platform_add_devices(yamo5410_media_devices,
			ARRAY_SIZE(yamo5410_media_devices));
...
/* Below should be enabled after power domain is available */
	...
	exynos5_fimc_is_data.gpio_info = &gpio_yamo5410;

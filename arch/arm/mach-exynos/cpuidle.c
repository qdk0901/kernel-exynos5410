...
static int gpio_pd_reg_dirty = 1;

void set_gpio_pd_reg_dirty(void)
{
	gpio_pd_reg_dirty = 1;
}

int get_gpio_pd_reg_dirty(void)
{
	return gpio_pd_reg_dirty;
}

void clear_gpio_pd_reg_dirty(void)
{
	gpio_pd_reg_dirty = 0;
}

#ifdef CONFIG_EXYNOS5_TF4_LOW_POWER_GPIO
static unsigned int tf4_LPA_pd_gpio_table[][3] =
{
	{ EXYNOS5410_GPC0(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC0(1),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, 
	{ EXYNOS5410_GPC0(2),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, 
	{ EXYNOS5410_GPC0(3),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, 
	{ EXYNOS5410_GPC0(4),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC0(5),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC0(6),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},	

	{ EXYNOS5410_GPC3(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC3(1),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC3(2),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},	
	{ EXYNOS5410_GPC3(3),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},	
	
	{ EXYNOS5410_GPC1(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, 
	{ EXYNOS5410_GPC1(1),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, 
	
	{ EXYNOS5410_GPC1(3),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, 
	{ EXYNOS5410_GPC1(4),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC1(5),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC1(6),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},	
	
	{ EXYNOS5410_GPF1(4),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN}, 
	{ EXYNOS5410_GPF1(6),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, 
	{ EXYNOS5410_GPF1(7),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, 

	{ EXYNOS5410_GPG0(1),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},
	
	
	{ EXYNOS5410_GPG1(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPG1(6),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPG1(7),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	
	{ EXYNOS5410_GPY3(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPY3(3),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	
	{ EXYNOS5410_GPY4(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPY4(5),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},
	
	{ EXYNOS5410_GPY5(1),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	
	{ EXYNOS5410_GPY6(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},
	{ EXYNOS5410_GPY6(2),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},
	{ EXYNOS5410_GPY6(3),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPY6(7),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},
	{ EXYNOS5410_GPJ0(0),  S3C_GPIO_SLP_OUT0,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPK1(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN}, 
	{ EXYNOS5410_GPK1(5),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},	
	{ EXYNOS5410_GPK1(6),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE},

	//GREEN LED
	{ EXYNOS5410_GPK0(7),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},

	//TF
	{ EXYNOS5410_GPC2(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC2(1),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC2(2),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC2(3),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC2(4),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC2(5),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	{ EXYNOS5410_GPC2(6),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
	
	//TFLASH_PWER_EN
	{ EXYNOS5410_GPY2(4),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},

	//WIFI (N.C)	
	{ EXYNOS5410_GPC1(2),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},
...
static void exynos_gpio_set_pd_reg(void)
{
	...
	u32 i, gpio;
#ifndef CONFIG_EXYNOS5_TF4_LOW_POWER_GPIO
	unsigned int gpio_nr, tmp;
#endif
	
	if (!get_gpio_pd_reg_dirty()) {
		return;
	}
#ifdef CONFIG_EXYNOS5_TF4_LOW_POWER_GPIO
	for (i = 0; i < ARRAY_SIZE(tf4_LPA_pd_gpio_table); i++) {
		gpio = tf4_LPA_pd_gpio_table[i][0];
		s5p_gpio_set_pd_cfg(gpio, tf4_LPA_pd_gpio_table[i][1]);
		s5p_gpio_set_pd_pull(gpio, tf4_LPA_pd_gpio_table[i][2]);
	}
#endif

#ifndef CONFIG_EXYNOS5_TF4_LOW_POWER_GPIO
	pr_debug("Controlling GPIO power down to all PREVIOUS.\n");

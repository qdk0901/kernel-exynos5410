...
// NFC
#ifdef CONFIG_SEC_NFC_UART
#define GPIO_NFC_VEN	EXYNOS5410_GPF1(0)
#define GPIO_NFC_FIRM	EXYNOS5410_GPF1(1)

static void exynos5_init_nfc_gpio(void)
{
...
//NFC
static struct sec_nfc_platform_data exynos5_nfc_info = {
	.ven = GPIO_NFC_VEN,
	.firm = GPIO_NFC_FIRM,
	.cfg_gpio = exynos5_init_nfc_gpio,
};
...
static struct platform_device s3c_device_nfc_uart = {
	...
	.dev.platform_data	= &exynos5_nfc_info,
};
#endif
...
static struct platform_device *yamo5410_sensor_i2c_devices[] __initdata = {
	&gpio_i2c6_dev,
	&gpio_i2c7_dev,
};
...
void __init exynos5_yamo5410_sensor_init(void)
{
	i2c_register_board_info(6, i2c_devs6, ARRAY_SIZE(i2c_devs6));
	i2c_register_board_info(7, i2c_devs7, ARRAY_SIZE(i2c_devs7));
	platform_add_devices(yamo5410_sensor_i2c_devices, ARRAY_SIZE(yamo5410_sensor_i2c_devices));
}
#endif

//i2c3 //jylee, add for APDS990x Light Sensor@2013-01-31
#ifdef CONFIG_SENSOR_APDS990x
static struct i2c_gpio_platform_data gpio_i2c3_data  = {
	.sda_pin	= EXYNOS5410_GPA1(2),
	.scl_pin	= EXYNOS5410_GPA1(3),
	.udelay	= 50,
};
...
static struct platform_device *yamo5410_lightsensor_i2c_devices[] __initdata = {
	&gpio_i2c3_dev,
};
...
void __init exynos5_yamo5410_lightsensor_init(void)
{
	i2c_register_board_info(3, i2c_devs3, ARRAY_SIZE(i2c_devs3));
	platform_add_devices(yamo5410_lightsensor_i2c_devices, ARRAY_SIZE(yamo5410_lightsensor_i2c_devices));
}
#endif /* CONFIG_SENSOR_APDS990x */
		...
		unsigned long code, void *_cmd)
{
	...
	if ((code == SYS_RESTART) && _cmd) {
		if (!strcmp((char *)_cmd, "recovery"))
			mode = 0xf;
		if (!strcmp((char *)_cmd, "firmware_update"))
			mode = 0xff;
		if (!strcmp((char *)_cmd, "factory_reset"))
			mode = 0xfffa;
	}
...
#ifdef CONFIG_EXYNOS5_YAMO5410_LOW_POWER_GPIO
static unsigned int yamo5410_boot_pd_gpio_table[][3] = {
...
//#ifdef CONFIG_SND_SOC_SAMSUNG_YAMO5410_WM1811
...
#ifdef CONFIG_EXYNOS5_YAMO5410_LOW_POWER_GPIO
static unsigned int yamo5410_sleep_gpio_table[][3] =
{
	{ EXYNOS5410_GPC0(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN}, 
	{ EXYNOS5410_GPC0(1),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN}, 
	{ EXYNOS5410_GPC0(2),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN}, 
...
//#endif
	...
	{ EXYNOS5410_GPK0(7),  S3C_GPIO_SLP_OUT0,	S3C_GPIO_PULL_NONE},
...
#ifdef CONFIG_EXYNOS5_YAMO5410_LOW_POWER_GPIO
static unsigned int yamo5410_boot_normal_gpio_table[][4] =
{
	{ EXYNOS5410_GPA0(0),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPA0(1),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPA0(2),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPA0(3),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPA0(4),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPA0(5),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPA0(6),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPA0(7),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_DOWN, -1},
                                            	
	{ EXYNOS5410_GPA1(0),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPA1(1),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPA1(2),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPA1(3),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPA1(4),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPA1(5),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1},

	{ EXYNOS5410_GPA2(0),  S3C_GPIO_SFN(0x3),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPA2(1),  S3C_GPIO_SFN(0x3),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPA2(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPA2(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPA2(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPA2(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPA2(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPA2(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
                                          		
	{ EXYNOS5410_GPB0(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPB0(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPB0(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPB0(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPB0(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	                                        		
	{ EXYNOS5410_GPB1(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPB1(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPB1(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPB1(3),  S3C_GPIO_SFN(0x4),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPB1(4),  S3C_GPIO_SFN(0x4),		S3C_GPIO_PULL_NONE, -1}, 

	{ EXYNOS5410_GPB2(0),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPB2(1),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_UP, 	S3C_GPIO_SETPIN_LOW}, 
	{ EXYNOS5410_GPB2(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPB2(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1}, 

	{ EXYNOS5410_GPB3(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPB3(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPB3(2),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPB3(3),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	
	{ EXYNOS5410_GPC0(0),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC0(1),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC0(2),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_UP, 	-1}, 
	{ EXYNOS5410_GPC0(3),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC0(4),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPC0(5),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPC0(6),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1},	

	{ EXYNOS5410_GPC3(0),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE,	-1}, 
	{ EXYNOS5410_GPC3(1),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC3(2),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC3(3),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
//#ifdef CONFIG_SND_SOC_SAMSUNG_YAMO5410_WM1811
	{ EXYNOS5410_GPC1(0),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1},
//#endif
	{ EXYNOS5410_GPC1(1),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC1(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPC1(3),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC1(4),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPC1(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPC1(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},

	{ EXYNOS5410_GPC2(0),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC2(1),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC2(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPC2(3),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPC2(4),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_UP, 	-1},
	{ EXYNOS5410_GPC2(5),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_UP, 	-1},
	{ EXYNOS5410_GPC2(6),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_UP, 	-1},
	
	{ EXYNOS5410_GPM5(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPM5(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	
	{ EXYNOS5410_GPD1(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPD1(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPD1(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPD1(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPD1(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPD1(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPD1(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPD1(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
                                          	
	/*GPX0 - GPX3 alive part*/
	{ EXYNOS5410_GPE0(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPE0(1),  S3C_GPIO_SFN(0x2), 		S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPE0(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPE0(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPE0(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPE0(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPE0(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPE0(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
/////////////////////////////////////////////////////////////////////

	{ EXYNOS5410_GPE1(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPE1(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 

	{ EXYNOS5410_GPF0(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPF0(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPF0(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPF0(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPF0(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPF0(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 


	{ EXYNOS5410_GPF1(0),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_LOW}, 
	{ EXYNOS5410_GPF1(1),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_LOW}, 
	{ EXYNOS5410_GPF1(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPF1(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPF1(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPF1(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPF1(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPF1(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1}, 	

	{ EXYNOS5410_GPG0(0),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_UP,	S3C_GPIO_SETPIN_HIGH}, 
	{ EXYNOS5410_GPG0(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPG0(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPG0(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPG0(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPG0(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},	
	{ EXYNOS5410_GPG0(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPG0(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	

	{ EXYNOS5410_GPG1(0),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_DOWN, S3C_GPIO_SETPIN_HIGH},
	{ EXYNOS5410_GPG1(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPG1(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPG1(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPG1(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPG1(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPG1(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPG1(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},	

	{ EXYNOS5410_GPG2(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPG2(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 	
	                                        		
	{ EXYNOS5410_GPH0(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPH0(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPH0(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPH0(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	                                        		
	{ EXYNOS5410_GPH1(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPH1(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPH1(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPH1(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPH1(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPH1(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPH1(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPH1(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},

///////////////////////////////////////////////////////////////////////////
	{ EXYNOS5410_GPM7(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPM7(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPM7(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPM7(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPM7(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPM7(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPM7(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPM7(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	                                        		
	{ EXYNOS5410_GPY0(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY0(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY0(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY0(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY0(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPY0(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
                                          		
	{ EXYNOS5410_GPY1(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPY1(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY1(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY1(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 

	{ EXYNOS5410_GPY2(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY2(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY2(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY2(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY2(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_UP,	-1},
	{ EXYNOS5410_GPY2(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	

	{ EXYNOS5410_GPY3(0),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY3(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY3(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY3(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY3(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPY3(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPY3(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY3(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	

	{ EXYNOS5410_GPY4(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY4(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY4(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY4(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY4(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPY4(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPY4(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY4(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	
////////////////////////////////////////////////////////////////////////
	{ EXYNOS5410_GPY5(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPY5(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY5(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY5(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY5(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPY5(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPY5(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPY5(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},	

	{ EXYNOS5410_GPY6(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY6(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY6(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY6(3),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_HIGH}, 
	{ EXYNOS5410_GPY6(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPY6(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPY6(6),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, -1},  
	{ EXYNOS5410_GPY6(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	

	{ EXYNOS5410_GPY7(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY7(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY7(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY7(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPY7(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPY7(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPY7(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPY7(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	

	//Alive
	/*Need check later on YAMO5410 EVT board!!, temp Here. */
	{ EXYNOS5410_GPX0(0),  S3C_GPIO_SFN(0xf), 		S3C_GPIO_PULL_UP, 	-1},  //PMIC_IRQB
	{ EXYNOS5410_GPX0(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},  //TSP_INT
	{ EXYNOS5410_GPX0(2),  S3C_GPIO_SFN(0xf), 		S3C_GPIO_PULL_NONE, -1},  //PMIC_ONOB
	{ EXYNOS5410_GPX0(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE,	-1},    //VOLDOWN_KEY
	{ EXYNOS5410_GPX0(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE,	-1},    //VOLUP_KEY
	{ EXYNOS5410_GPX0(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},  //GS_INT1
	{ EXYNOS5410_GPX0(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},  //GS_INT2
	{ EXYNOS5410_GPX0(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  //DP_HPD
                         
	{ EXYNOS5410_GPX1(0),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //3AXIS_RDY
	{ EXYNOS5410_GPX1(1),  S3C_GPIO_SFN(0xf), 		S3C_GPIO_PULL_DOWN, -1},  //GYRO_INT
	{ EXYNOS5410_GPX1(2),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_NONE, -1},  //CHG_IRQ
	{ EXYNOS5410_GPX1(3),  S3C_GPIO_SFN(0xf), 		S3C_GPIO_PULL_DOWN, -1},  //CODEC_INT
	{ EXYNOS5410_GPX1(4),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //WIFI_INT
	{ EXYNOS5410_GPX1(5),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //BGF_INT
	{ EXYNOS5410_GPX1(6),  S3C_GPIO_SFN(0xf), 		S3C_GPIO_PULL_NONE, -1},  //TF_nCD
	{ EXYNOS5410_GPX1(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},  //LIGHT_INT
                         
	{ EXYNOS5410_GPX2(0),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //MODEM_PWRSTATUS
	{ EXYNOS5410_GPX2(1),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //MODEM_EINT3
	{ EXYNOS5410_GPX2(2),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //MT11_INT
	{ EXYNOS5410_GPX2(3),  S3C_GPIO_SFN(0xf),		S3C_GPIO_PULL_NONE, -1}, // USB 3.0 ch0 vbus detect hunsoo.lee
	{ EXYNOS5410_GPX2(4),  S3C_GPIO_SFN(0xf), 		S3C_GPIO_PULL_UP, 	-1},    //USE3_IDDET
	{ EXYNOS5410_GPX2(5),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //USB2_VBUSDET
	{ EXYNOS5410_GPX2(6),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},    //USB2_IDDET
	{ EXYNOS5410_GPX2(7),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_NONE, -1},  //JACK_DET
                         
	{ EXYNOS5410_GPX3(0),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //MODEM_EINT1
	{ EXYNOS5410_GPX3(1),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //NFC_INT
	{ EXYNOS5410_GPX3(2),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //HSIC_AP_WAKEUP
	{ EXYNOS5410_GPX3(3),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //MODEM_EINT2
	{ EXYNOS5410_GPX3(4),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //TP
	{ EXYNOS5410_GPX3(5),  S3C_GPIO_INPUT, 			S3C_GPIO_PULL_DOWN, -1},  //HSIC_SUSPEND_REQ
	{ EXYNOS5410_GPX3(6),  S3C_GPIO_SFN(0x3), 		S3C_GPIO_PULL_NONE, -1},  //HDMI_CEC
	{ EXYNOS5410_GPX3(7),  S3C_GPIO_SFN(0xf), 		S3C_GPIO_PULL_NONE, -1},  //HDMI_HPD
	
	{ EXYNOS5410_GPV0(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPV0(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPV0(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPV0(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPV0(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV0(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPV0(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV0(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
//
	{ EXYNOS5410_GPV1(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPV1(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV1(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV1(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPV1(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV1(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPV1(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV1(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},

///////////////////////////////////////////////////////////////////////
	{ EXYNOS5410_GPV2(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV2(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV2(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV2(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV2(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV2(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV2(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV2(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},

	{ EXYNOS5410_GPV3(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV3(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV3(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPV3(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV3(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV3(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPV3(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV3(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},

	{ EXYNOS5410_GPV4(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPV4(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},

	{ EXYNOS5410_GPJ0(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ0(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ0(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ0(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ0(4),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_HIGH},

	{ EXYNOS5410_GPJ1(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ1(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ1(2),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_HIGH}, 
	{ EXYNOS5410_GPJ1(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPJ1(4),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_HIGH},
	{ EXYNOS5410_GPJ1(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 	
	{ EXYNOS5410_GPJ1(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ1(7),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_HIGH},

	{ EXYNOS5410_GPJ2(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPJ2(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPJ2(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPJ2(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},  
	{ EXYNOS5410_GPJ2(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPJ2(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 	
	{ EXYNOS5410_GPJ2(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ2(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	
	{ EXYNOS5410_GPJ3(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ3(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ3(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ3(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPJ3(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPJ3(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPJ3(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPJ3(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},

///////////////////////////////////////////////////////////////////////	
	{ EXYNOS5410_GPJ4(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPJ4(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},

	{ EXYNOS5410_GPK0(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPK0(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPK0(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPK0(3),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_HIGH}, 
	{ EXYNOS5410_GPK0(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPK0(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPK0(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPK0(7),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_HIGH},
	
	{ EXYNOS5410_GPK1(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPK1(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPK1(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPK1(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPK1(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPK1(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPK1(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_NONE, -1},
	{ EXYNOS5410_GPK1(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},

	{ EXYNOS5410_GPK2(0),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPK2(1),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1}, 
	{ EXYNOS5410_GPK2(2),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPK2(3),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPK2(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPK2(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPK2(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPK2(7),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	
	{ EXYNOS5410_GPK3(0),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPK3(1),  S3C_GPIO_SFN(0x2),		S3C_GPIO_PULL_NONE, -1}, 
	{ EXYNOS5410_GPK3(2),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_LOW},
	{ EXYNOS5410_GPK3(3),  S3C_GPIO_OUTPUT,			S3C_GPIO_PULL_NONE, S3C_GPIO_SETPIN_LOW}, 
	{ EXYNOS5410_GPK3(4),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
	{ EXYNOS5410_GPK3(5),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},	
	{ EXYNOS5410_GPK3(6),  S3C_GPIO_INPUT,			S3C_GPIO_PULL_DOWN, -1},
...
#ifdef CONFIG_EXYNOS5_YAMO5410_LOW_POWER_GPIO
static void exynos5_yamo5410_gpio_init(void)
{
	// Power Down GPIO Setting on Booting
	u32 i, gpio;

	set_gpio_pd_reg_dirty();
	for (i = 0; i < ARRAY_SIZE(yamo5410_boot_pd_gpio_table); i++) {
		gpio = yamo5410_boot_pd_gpio_table[i][0];
		s5p_gpio_set_pd_cfg(gpio, yamo5410_boot_pd_gpio_table[i][1]);
		s5p_gpio_set_pd_pull(gpio, yamo5410_boot_pd_gpio_table[i][2]);
	}

	// Normal GPIO Setting on Booting
	for (i = 0; i < ARRAY_SIZE(yamo5410_boot_normal_gpio_table); i++){
		gpio = yamo5410_boot_normal_gpio_table[i][0];
		s3c_gpio_cfgpin(gpio, S3C_GPIO_SFN(yamo5410_boot_normal_gpio_table[i][1]));
		s3c_gpio_setpull(gpio, yamo5410_boot_normal_gpio_table[i][2]);
		if(yamo5410_boot_normal_gpio_table[i][3]!=-1)
			gpio_set_value(yamo5410_boot_normal_gpio_table[i][0], yamo5410_boot_normal_gpio_table[i][3]);
 	}	
}
#endif
...
#ifdef CONFIG_EXYNOS5_YAMO5410_LOW_POWER_GPIO
static unsigned int yamo5410_sleep_alive_gpio_table[][3] =
{
	/*Need check later on YAMO5410 EVT board!!, temp Here. */
	...
	{EXYNOS5410_GPX0(3), S3C_GPIO_INPUT,	S3C_GPIO_PULL_NONE},    //VOLDOWN_KEY
	{EXYNOS5410_GPX0(4), S3C_GPIO_INPUT,	S3C_GPIO_PULL_NONE},    //VOLUP_KEY
	...
	{EXYNOS5410_GPX1(6), S3C_GPIO_SFN(0xf),	S3C_GPIO_PULL_NONE},  //TF_nCD
	...
	// usb_vbus must be wakable irq while sleep mode
...
extern void (*s3c_config_sleep_powerdown_gpio_table)(void);
extern void (*s3c_config_sleep_normal_gpio_table)(void);

static void yamo5410_config_sleep_powerdown_gpio_table(void)
{
#ifdef CONFIG_EXYNOS5_YAMO5410_LOW_POWER_GPIO
	printk("-yamo5410_config_sleep_powerdown_gpio_table\n ");	
	config_sleep_gpio_table(ARRAY_SIZE(yamo5410_sleep_gpio_table),
			yamo5410_sleep_gpio_table); 
#endif
}

static void yamo5410_config_sleep_normal_gpio_table(void)
{
	/*TO DO. unfinished*/
	int i=0, gpio;

	printk("-config yamo5410_config_sleep_normal_gpio_table\n ");
...
#ifdef CONFIG_EXYNOS5_YAMO5410_LOW_POWER_GPIO
	for (i = 0; i < ARRAY_SIZE(yamo5410_sleep_alive_gpio_table); i++)
  	{
		  gpio = yamo5410_sleep_alive_gpio_table[i][0];
		  s3c_gpio_cfgpin(gpio, S3C_GPIO_SFN(yamo5410_sleep_alive_gpio_table[i][1]));
		  s3c_gpio_setpull(gpio, yamo5410_sleep_alive_gpio_table[i][2]);
 	}
#endif
}
...
static void yamo5410_power_off(void)
{
	unsigned int reg;
...
static void yamo5410_power_off_prepare(void)
{
...
static void __init smdk5410_machine_init(void)
{
	...
	exynos5_yamo5410_clock_init();
	exynos5_yamo5410_mmc_init();
	...
	exynos5_yamo5410_audio_init();
	exynos5_yamo5410_usb_init();
	exynos5_yamo5410_power_init();
	exynos5_yamo5410_input_init();
	exynos5_yamo5410_media_init();
	exynos5_yamo5410_display_init();
	exynos5_yamo5410_bt_init();
	yamo5410_nfc_init();

#ifdef CONFIG_INV_SENSORS
	exynos5_yamo5410_sensor_init(); // shengliang: @2012-07-25
#endif
#ifdef CONFIG_SENSOR_APDS990x  // jylee: @2013-01-31
	exynos5_yamo5410_lightsensor_init();
#endif

	s3c_config_sleep_powerdown_gpio_table = yamo5410_config_sleep_powerdown_gpio_table;
	s3c_config_sleep_normal_gpio_table = yamo5410_config_sleep_normal_gpio_table;
	ramconsole_pdata.bootinfo = exynos_get_resetreason();
	platform_add_devices(smdk5410_devices, ARRAY_SIZE(smdk5410_devices));

	pm_power_off = yamo5410_power_off;
	pm_power_off_prepare = yamo5410_power_off_prepare;

	register_reboot_notifier(&exynos5_reboot_notifier);
}

MACHINE_START(YAMO5410, "YAMO5410")
	.atag_offset	= 0x100,

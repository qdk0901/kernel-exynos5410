...
#if defined (CONFIG_MACH_TF4)||(CONFIG_MACH_YAMO5410)
...
#if defined (CONFIG_MACH_TF4)||(CONFIG_MACH_YAMO5410)
        switch_set_state(&usb_audio_switch, 2);
#endif
		return 0;
	} else
		return -EIO;
...
{
#if defined (CONFIG_MACH_TF4)||(CONFIG_MACH_YAMO5410)
    switch_set_state(&usb_audio_switch, 0);
#endif
...
#if defined (CONFIG_MACH_TF4)||(CONFIG_MACH_YAMO5410)
    switch_dev_register(&usb_audio_switch);
#endif

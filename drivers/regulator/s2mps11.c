...
#include "../../../arch/arm/mach-exynos/board-yamo5410.h"
#else
#include "../../../arch/arm/mach-exynos/board-tf4.h"
#endif

#define BUCK5_SW1_ALWAYS_ON
...
//NORMAL, LPA, STANDBY
	...
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO14,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO15,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO16,	// not used
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO17,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO18,	// EMMC_1v8, Output on/off by LDO 16EN
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO19,	// TFLASH_2v8 output on/off by LDO 19EN
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO20,	// not used
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO21,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO22,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO23,	// not used
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO24,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO25,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO26,	// not used
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO27,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO28,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO29,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO30,	// not used
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO31,
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO32,	// not used
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO33,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO34,	// not used
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO35,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO36,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO37,	// not used
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO38,	// not used
...
static __devinit int s2mps11_pmic_probe(struct platform_device *pdev)
{
	...
	u8 val = 0;
  enum board_version_type temp_version = BOARD_EVT;
   ...
   sec_reg_read(s2mps11->iodev, S2MPS11_REG_RTC_CTRL, &val);
	...
	//BUCK5 register setting
	temp_version = get_board_version(); 
#ifdef BUCK5_SW1_ALWAYS_ON
	sec_reg_write(s2mps11->iodev, 0x2E, 0x17);
#else
	if(temp_version == BOARD_DVT || temp_version == BOARD_EVT)
		sec_reg_write(s2mps11->iodev, 0x2E, 0x17);  // FOR EVT DVT
	else // BOARD_PVT
		sec_reg_write(s2mps11->iodev, 0x2E, 0x15);  // FOR PVT
#endif 
